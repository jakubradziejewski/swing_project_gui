...
public class GameGUI extends JFrame {
    ...
    private static class GamePanel extends JPanel {
        ...
        private void loadImages() {
            try {
                rabbitImage = ImageIO.read(new File("./src/rabbit.jpg"));
            ...
            try {
                farmerImage = ImageIO.read(new File("./src/farmer.jpg"));
            ...
            try {
                farmer1Image = ImageIO.read(new File("./src/farmer1.jpg"));
            ...
            try {
                carrotImage = ImageIO.read(new File("./src/carrot.jpg"));
            ...
            try {
                dogImage = ImageIO.read(new File("./src/dog.jpg"));
